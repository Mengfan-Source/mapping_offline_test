...
#ifndef XMF_KEYFRAME_H
#define XMF_KEYFRAME_H
...
struct Keyframe {
    ...
    void Save_lio_tum_pose(std::ostream &os) ;
    void Save_lc_tum_pose(std::ostream &os) ;
    /// 从文件读取
...
using KFPtr = std::shared_ptr<xmf::Keyframe>;
