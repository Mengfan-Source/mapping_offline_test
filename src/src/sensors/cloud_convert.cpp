...
void CloudConvert::Process(const livox_ros_driver2::CustomMsg::ConstPtr &msg, FullCloudPtr &pcl_out) {
    Mid360Handler(msg);
    *pcl_out = cloud_out_;
}
...
void CloudConvert::Mid360Handler(const livox_ros_driver2::CustomMsg::ConstPtr &msg) {
    cloud_out_.clear();
    cloud_full_.clear();
